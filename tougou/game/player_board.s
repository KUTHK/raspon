/*--------------------------------------
player_board.s: プレイヤーボード制御・座標管理・入力反映

input: TS_switch_out（スイッチ入力）
output: TS_player1_board, TS_player2_board（各プレイヤーボード座標）

TS_player_board: プレイヤーボードの動作・座標更新
--------------------------------------*/
	@ 2人のプレイヤーのボードを動かすサブルーチン
    @ 一定時間内にスイッチが押されていればボードの中心座標が左右に動く
